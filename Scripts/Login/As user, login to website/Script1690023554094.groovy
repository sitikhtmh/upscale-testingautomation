...
WebUI.setText(findTestObject('Object Repository/Login/input_Email_email (1)'), 'sasyaa@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Login/input_Password_password (1)'), 'S0uUgLc4dLWJ9+fKC0XPIw==')

WebUI.click(findTestObject('Object Repository/Login/button_Login (1)'))
